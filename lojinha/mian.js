...
function addCarrinho(itemNome, itemPreco){
    ...
    if(itensCarrinho[itemNome]){
        ...
        <div class="item">
            <span>${itemNome}</span>
            <button class="remove" style="width: 23px;
            height: 23px;" onclick="removeCarrinho('${itemNome}', ${itemPreco})">-</button>
            <span class="quantity">1</span>
            <button class="add" style="width: 23px;
            height: 23px;" onclick="addCarrinho('${itemNome}', ${itemPreco})">+</button>
